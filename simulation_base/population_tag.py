...
class PopulationTag:
    ...
    def __hash__(self) -> int:
        ...
        return hash((self.name, self.short_name, self.plural_name, self.hex_color, tuple(sorted(self.loyalty.items()))))
    ...
    def party_loyalty(self, other: 'PopulationTag') -> float:
        """Get loyalty score for another party."""
        return self.loyalty.get(other.short_name, 0.0)
