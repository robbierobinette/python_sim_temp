#!/usr/bin/env python3
"""
Test script for the simplified OpenPrimary election process.
"""
import sys
import os
...
def test_open_primary_simplified():
    """Test the simplified open primary election process."""
    print("Testing simplified OpenPrimary...")
    ...
    primary_config = OpenPrimaryConfig(use_runoff=False)
    ...
    primary_config_with_runoff = OpenPrimaryConfig(use_runoff=True)
